...
| 63 | `63_disk_hnsw_planning.md` | Performance | ✅ SHIPPED 2026-07-17 — on-disk HNSW replaces IVF-Flat (recall@10=0.421 gate unlocked). src/hnsw_index.rs; 48/48 crash tests; clippy/fmt clean. Release recall bench pending. |
