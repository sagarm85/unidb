...
| 54 | `54_select_filtered_arena_alloc.md` | Performance | ⏳ IN PROGRESS — item 45 Lever 3: Phase A implemented (`scan_page_visit` + `project_row_drain` + `parallel_resolve_partitions`); benchmark pending bench-slot approval. |
