...
| 58 | `58_hot_update.md` | Performance | ⏳ IN PROGRESS — HOT-equivalent UPDATE: same-page insert when no indexed col in SET; B-tree stays at old slot; hot_next forwarding pointer; FORMAT_VERSION 7→8; P59a/P59b crash tests. Branch 58-hot-update. |
