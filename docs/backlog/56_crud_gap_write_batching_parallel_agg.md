...
**Type:** Performance
**Status:** SHIPPED — Step 1 SHIPPED 2026-07-16 (1.14× PG); Steps 2+3 SHIPPED 2026-07-17 (branch `56-step3-delete-wal-batch`, benchmark_20260717_074259.md); A6 PASS (DELETE WAL 72 B/row); A3/A4/A5 honest-miss — see PROGRESS.md for root-cause analysis; Step 4 SHIPPED 2026-07-17 (branch `56-step4-logical-btree-wal`, benchmark_20260717_021445.md): A8 INSERT WAL 655 B/row (13.5× reduction from 8,837), INSERT rec/s +25% (3,336→4,157), unidb÷PG 0.44×→0.54×; 32/32 conc matrix; FORMAT_VERSION 6→7
