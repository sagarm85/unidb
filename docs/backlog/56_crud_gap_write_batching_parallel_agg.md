...
**Type:** Performance
**Status:** IN PROGRESS — Step 1 SHIPPED 2026-07-16 PR #136 (1.14× PG); Step 3 SHIPPED 2026-07-17 PR #137 MERGED (WAL_XMAX_BATCH, A6 PASS DELETE WAL 72 B/row, FORMAT_VERSION→6); Step 2 UPDATE batch benchmarked + reverted (3-decode-pass regression; `Heap::update_many` kept in heap.rs); Step 4 gated — see PROGRESS.md
