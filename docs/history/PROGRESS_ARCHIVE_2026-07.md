# PROGRESS.md archive — entries rolled out on 2026-07-22

> Verbatim entries moved from `PROGRESS.md`; headings preserved exactly so
> every `see PROGRESS.md "..."` reference still resolves by grep.
