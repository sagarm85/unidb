...
src/
  ...
  disk_vector.rs   — P3.c spike: on-disk IVF-Flat vector index (posting lists = durable DiskBTree); recall-validated, production wiring is a follow-up
